                         ...
                         <div class="widget-body">
                             <div class="timeline-messages">
                                 ...
                                 <div class="msg-time-chat">
                                     <a class="message-img" href="#"><img alt="" src="{{asset('public/back/img/avatar1.jpg')}}" class="avatar"></a>
                                 ...
                                 <!-- Comment -->
                                 <div class="msg-time-chat">
                                     <a class="message-img" href="#"><img alt="" src="{{asset('public/back/img/avatar2.jpg')}}" class="avatar"></a>
